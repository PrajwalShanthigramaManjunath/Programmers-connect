...
router.post(
  ...
  async (req, res) => {
    ...
    if (linkedin) profileFields.social.twitter = twitter;
    if (instagram) profileFields.social.twitter = twitter;
...
router.get('/github/:username', async (req, res) => {
  try {
    ...
    // https://api.github.com/users/PrajwalShanthigramaManjunath/repos?per_page=5&sort=created:asc
    console.log(uri);
    const headers = {
      'user-agent': 'node.js',
